...
<template>
  <div class="h-full min-h-0 overflow-y-auto p-16px bg-layout">
    <NGrid responsive="screen" item-responsive :x-gap="16" :y-gap="16" cols="24" class="min-h-full">
      <!-- Left Column -->
      <NGi span="24 s:24 m:6" class="h-full">
        <div class="flex flex-col h-full gap-16px">
          <NCard :bordered="false" size="small" class="panel-card flex-1">
            ...
            <div ref="taskDistributionDomRef" class="h-full min-h-0 w-full"></div>
          </NCard>
          <NCard :bordered="false" size="small" class="panel-card flex-1">
            <template #header>
              <div class="panel-header">
            ...
            <div ref="taskTrendDomRef" class="h-full min-h-0 w-full"></div>
          </NCard>
          <NCard :bordered="false" size="small" class="panel-card flex-1">
            <template #header>
              <div class="panel-header">
            ...
            <div ref="systemStatusDomRef" class="h-full min-h-0 w-full"></div>
          </NCard>
        </div>
      </NGi>
      ...
      <NGi span="24 s:24 m:12" class="h-full">
        <div class="flex flex-col h-full gap-16px">
          <!-- Top KPIs -->
          <NGrid responsive="screen" item-responsive :x-gap="12" :y-gap="12" cols="24" class="shrink-0">
          ...
          <!-- Bottom 3 Charts -->
          <NGrid responsive="screen" item-responsive :x-gap="16" :y-gap="16" cols="24" class="shrink-0 h-220px">
            <NGi span="24 m:8">
              <NCard :bordered="false" size="small" title="数据分布类型" class="panel-card !h-full">
                <div ref="bottomDistDomRef" class="h-full w-full"></div>
              </NCard>
            </NGi>
            <NGi span="24 m:8">
              <NCard :bordered="false" size="small" title="空间数据覆盖" class="panel-card !h-full">
                <div ref="bottomRadarDomRef" class="h-full w-full"></div>
              </NCard>
            </NGi>
            <NGi span="24 m:8">
              <NCard :bordered="false" size="small" title="数据更新趋势" class="panel-card !h-full">
                <div ref="bottomTrendDomRef" class="h-full w-full"></div>
              </NCard>
            </NGi>
          </NGrid>
        </div>
      ...
      <NGi span="24 s:24 m:6" class="h-full">
        <div class="flex flex-col h-full gap-16px">
          <NCard :bordered="false" size="small" class="panel-card flex-1">
            ...
            <div ref="hotKeywordsDomRef" class="h-full min-h-0 w-full"></div>
          </NCard>
          <NCard :bordered="false" size="small" class="panel-card flex-1">
            <template #header>
              <div class="panel-header">
            ...
            <div ref="aiRankDomRef" class="h-full min-h-0 w-full"></div>
          </NCard>
