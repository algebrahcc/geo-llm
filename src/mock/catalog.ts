...
export const catalogData: CatalogItem[] = [
  // ═══════════════ 1. 遥感影像 (8 items) ═══════════════
  {
    ...
    tags: ['卫星影像', '多光谱', '长江流域'],
    quality: q(95, 92, 88),
    lineage: lin('卫星采集', ['原始数据接收', '辐射校正', '几何校正', '正射纠正', '镶嵌裁剪'], 'v2.1', '2026-05-10'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['geo-analysis', 'mobility-planning'],
    scenarioTags: ['地形分析', '态势感知'],
    audit: { auditor: '张工', auditTime: '2026-05-20', status: 'approved' },
  ...
  },
  {
    ...
    tags: ['卫星影像', '西部', '荒漠化'],
    quality: q(88, 85, 82),
    lineage: lin('卫星采集', ['数据接收', '预处理', '镶嵌'], 'v1.3', '2026-03-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['geo-analysis', 'mobility-planning'],
    scenarioTags: ['地形分析', '态势感知'],
    audit: { auditor: '张工', auditTime: '2026-05-03', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 3,
    ...
    bbox: [114.8, 28.5, 122.9, 35.0],
    updateTime: '2026-04-20',
    tags: ['高分卫星', 'IMG格式', '华东'],
    quality: q(96, 94, 90),
    lineage: lin('高分专项数据中心', ['数据分发', '格式转换(IMG)', '金字塔构建', '质量检查'], 'v2.0', '2026-04-01'),
    standardizeStatus: {
    ...
    agentBinding: ['geo-analysis', 'image-recognition', 'mobility-planning'],
    scenarioTags: ['城市攻防', '交通研判', '态势感知'],
    audit: { auditor: '李工', auditTime: '2026-04-18', status: 'approved', comments: '质量优秀' },
    finetuneStatus: {
      used: true,
      taskTypes: ['目标检测', '语义分割'],
      sampleCount: 5000,
      annotationComplete: 85,
      modelVersion: 'YOLOv8-geo-v2'
    }
  },
  {
    id: 4,
    name: '全国SAR雷达影像 (GRST格式)',
    ingestTime: '2026-03-18',
    timePhase: '2026Q1',
    range: '全国',
    type: '遥感影像',
    status: 'published',
    ...
    tags: ['SAR', 'GRST格式', '雷达', '全天候'],
    quality: q(92, 90, 87),
    lineage: lin(
      'SAR卫星数据中心',
      ['SLC数据接收', '多视处理', '滤波', '地理编码(GRST)', '镶嵌'],
      'v1.5',
      '2026-02-20'
    ),
    standardizeStatus: {
    ...
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['geo-analysis', 'image-recognition'],
    scenarioTags: ['态势感知', '目标识别', '地形分析'],
    audit: { auditor: '王工', auditTime: '2026-03-15', status: 'approved' },
    finetuneStatus: {
      used: true,
      taskTypes: ['变化检测', '地物分类'],
      sampleCount: 12000,
      annotationComplete: 70,
      modelVersion: 'SARNet-v1'
    }
  },
  {
    id: 5,
    name: '重点城市多光谱影像',
    ingestTime: '2026-05-12',
    timePhase: '2026Q2',
    range: '东部沿海城市',
    type: '遥感影像',
    status: 'published',
    ...
    format: 'GeoTIFF',
    resolution: '10m',
    coordinateSystem: 'WGS 84 / UTM Zone 50N',
    bbox: [116.0, 22.0, 123.0, 40.0],
    updateTime: '2026-05-12',
    tags: ['多光谱', 'Sentinel-2', '波段分析'],
    quality: q(94, 93, 89),
    lineage: lin('ESA Copernicus', ['L1C下载', '大气校正(L2A)', '波段合成', '裁剪'], 'v2.0', '2026-05-01'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['geo-analysis', 'river-crossing'],
    scenarioTags: ['地形分析', '渡河保障', '态势感知'],
    audit: { auditor: '张工', auditTime: '2026-05-10', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 6,
    name: '沿海城市航空摄影',
    ingestTime: '2026-04-10',
    timePhase: '2025Q4',
    range: '某沿海城市',
    type: '遥感影像',
    status: 'published',
    ...
    resolution: '0.2m',
    coordinateSystem: 'CGCS 2000',
    bbox: [120.5, 29.8, 122.2, 31.5],
    updateTime: '2026-04-10',
    tags: ['航空摄影', '高分辨率', '正射影像'],
    quality: q(97, 88, 92),
    lineage: lin('测绘航空', ['航线规划', '航空拍摄', '空三加密', '正射纠正', '匀光匀色'], 'v3.0', '2025-11-20'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['TMS', 'WMS', 'WMTS']),
  ...
  },
  {
    ...
    tags: ['夜光', '夜间灯光', '人口密度'],
    quality: q(85, 80, 78),
    lineage: lin('NOAA', ['原始数据下载', '辐射校正', '年度合成', '投影转换'], 'v1.0', '2026-01-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS']),
    agentBinding: ['geo-analysis', 'mobility-planning'],
    scenarioTags: ['态势感知', '城市攻防'],
    audit: { auditor: '张工', auditTime: '2026-03-25', status: 'pending' },
    finetuneStatus: { used: false }
  },
  {
    id: 8,
    name: 'SAR时序变化检测数据 (GRST格式)',
    ...
    resolution: '5m',
    coordinateSystem: 'WGS 84',
    bbox: [97.0, 21.0, 108.0, 29.0],
    updateTime: '2026-05-08',
    tags: ['SAR', 'GRST格式', '变化检测', '多时相'],
    quality: q(90, 88, 85),
    lineage: lin(
      'SAR卫星数据中心',
      ['多时相SLC获取', '配准', '干涉处理', '变化检测', 'GRST编码'],
      'v1.2',
      '2026-04-15'
    ),
    standardizeStatus: {
    ...
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['image-recognition', 'geo-analysis'],
    scenarioTags: ['目标识别', '态势感知', '城市攻防'],
  ...
  // ═══════════════ 2. 数字高程 (6 items) ═══════════════
  {
    ...
    quality: q(90, 88, 85),
    lineage: lin('SRTM数据中心', ['原始雷达数据', '相位解缠', '高程提取', '空洞填补(ASTER)'], 'v3.0', '2026-04-01'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['geo-analysis', 'river-crossing', 'mobility-planning'],
    scenarioTags: ['地形分析', '渡河保障', '机动路线规划'],
    audit: { auditor: '张工', auditTime: '2026-05-16', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 102,
    ...
    tags: ['DEM', '全国', 'SRTM', '地形'],
    quality: q(92, 90, 87),
    lineage: lin('SRTM V3.0', ['雷达数据处理', '全球拼接', '空洞填补', '投影转换'], 'v3.0', '2025-12-01'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['TMS', 'WMS', 'WMTS']),
    agentBinding: ['geo-analysis', 'mobility-planning', 'river-crossing'],
    scenarioTags: ['地形分析', '态势感知'],
    audit: { auditor: '李工', auditTime: '2026-04-25', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 103,
    name: '重点城市高分辨率 DEM (EGC格式)',
    ...
    tags: ['DEM', 'EGC格式', '高分辨率', 'LiDAR'],
    quality: q(97, 92, 95),
    lineage: lin('机载LiDAR', ['点云获取', '地面点分类', 'DEM生成(5m)', 'EGC编码', '质量检查'], 'v2.0', '2026-02-20'),
    standardizeStatus: {
      coordinateTransformed: true,
      targetCRS: 'CGCS 2000',
      fieldMapped: true,
  ...
  {
    id: 104,
    name: 'DSM 数字地表模型（含建筑物）',
    ingestTime: '2026-04-15',
    timePhase: '2025Q4',
    range: '某城市主城区',
    type: '数字高程',
    status: 'published',
    ...
    tags: ['DSM', '地表模型', '建筑高度'],
    quality: q(94, 88, 90),
    lineage: lin('航空摄影测量', ['航空拍摄', '密集匹配', 'DSM生成', '噪声去除', '编辑'], 'v1.5', '2025-12-10'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
  ...
  {
    id: 105,
    name: '沿海海底地形 DEM (GRST格式)',
    ingestTime: '2026-03-20',
    timePhase: '2025',
    range: '东南沿海',
    type: '数字高程',
    status: 'draft',
    ...
    resolution: '10m',
    coordinateSystem: 'WGS 84',
    bbox: [116.0, 21.0, 122.0, 28.0],
    updateTime: '2026-03-20',
    tags: ['DEM', 'GRST格式', '海底地形', '渡河'],
    quality: q(82, 78, 80),
    lineage: lin('海洋测绘', ['多波束测深', '数据清理', '潮位改正', 'DEM生成', 'GRST编码'], 'v1.0', '2025-08-15'),
    standardizeStatus: {
      coordinateTransformed: true,
      targetCRS: 'WGS 84',
      fieldMapped: true,
    ...
    agentBinding: ['river-crossing', 'geo-analysis'],
    scenarioTags: ['渡河保障', '地形分析'],
    audit: { auditor: '王工', auditTime: '2026-03-18', status: 'pending', comments: '待补充潮位改正数据' },
    finetuneStatus: { used: false }
  },
  {
    id: 106,
    name: '战场区域精细 DEM (EGC格式)',
    ...
    resolution: '1m',
    coordinateSystem: 'CGCS 2000',
    bbox: [110.0, 30.0, 111.0, 31.0],
    updateTime: '2026-05-15',
    tags: ['DEM', 'EGC格式', '战场', '超高分辨率'],
    quality: q(96, 95, 94),
    lineage: lin('无人机LiDAR', ['航线规划', 'LiDAR扫描', '点云处理', 'DEM生成(1m)', 'EGC编码'], 'v2.0', '2026-04-20'),
    standardizeStatus: {
      coordinateTransformed: true,
      targetCRS: 'CGCS 2000',
      fieldMapped: true,
    ...
    tileStatus: tile(true, ['TMS', 'WMS', 'WMTS']),
    agentBinding: ['mobility-planning', 'geo-analysis', 'river-crossing'],
    scenarioTags: ['机动路线规划', '渡河保障', '地形分析', '城市攻防'],
    audit: { auditor: '张工', auditTime: '2026-05-13', status: 'approved' },
    finetuneStatus: { used: false }
  },
  ...
  },
  {
    ...
    resolution: '0.03m',
    coordinateSystem: 'CGCS 2000',
    bbox: [121.4, 31.2, 121.6, 31.3],
    updateTime: '2026-04-22',
    tags: ['倾斜摄影', '三维模型', '上海'],
    quality: q(97, 88, 95),
    lineage: lin('测绘航空', ['航线规划', '五镜头拍摄', '空三加密', '密集匹配', '模型重建'], 'v2.0', '2025-11-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['building-control', 'geo-analysis'],
  ...
  },
  {
    ...
    resolution: '0.08m',
    coordinateSystem: 'CGCS 2000',
    bbox: [110.0, 30.0, 110.8, 30.6],
    updateTime: '2026-05-08',
    tags: ['倾斜摄影', '战场', '实景三维'],
    quality: q(93, 90, 88),
    lineage: lin('军用无人机', ['航线规划', '多角度拍摄', '空三加密', '模型生成', '纹理优化'], 'v1.5', '2026-02-10'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
  ...
  },
  {
    ...
    resolution: '0.02m',
    coordinateSystem: 'CGCS 2000',
    bbox: [117.2, 34.5, 117.4, 34.6],
    updateTime: '2026-04-18',
    tags: ['单体模型', '桥梁', '精细化'],
    quality: q(98, 92, 96),
    lineage: lin(
      '无人机+地面扫描',
      ['无人机拍摄', '地面激光扫描', '点云融合', '模型重建', '纹理映射'],
      'v1.0',
      '2026-03-05'
    ),
    standardizeStatus: std(),
  ...
  {
    id: 205,
    name: '城市级 3D Tiles 瓦片模型',
    ingestTime: '2026-03-10',
    timePhase: '2025',
    range: '某省会城市',
    type: '倾斜摄影',
    status: 'published',
    ...
    resolution: '0.1m',
    coordinateSystem: 'CGCS 2000',
    bbox: [113.8, 34.5, 114.2, 34.9],
    updateTime: '2026-03-10',
    tags: ['3D Tiles', '城市级', 'LOD', 'Cesium'],
    quality: q(95, 85, 90),
    lineage: lin('航空摄影测量', ['航空拍摄', '空三加密', '模型重建', 'LOD生成', '3D Tiles编码'], 'v2.0', '2025-09-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['building-control', 'geo-analysis'],
  ...
  },
  {
    ...
    resolution: '0.04m',
    coordinateSystem: 'CGCS 2000',
    bbox: [108.9, 34.2, 109.1, 34.3],
    updateTime: '2026-02-25',
    tags: ['倾斜摄影', '历史建筑', '文化遗产'],
    quality: q(92, 82, 90),
    lineage: lin('测绘无人机', ['航线规划', '拍摄', '空三加密', '模型重建'], 'v1.0', '2025-08-20'),
    standardizeStatus: std(),
    tileStatus: tile(false, []),
    agentBinding: ['building-control', 'geo-analysis'],
    scenarioTags: ['楼宇夺控', '城市攻防'],
  ...
  // ═══════════════ 4. 气象水文 (7 items) ═══════════════
  {
    ...
    tags: ['气象', '降雨', '华东'],
    quality: q(88, 95, 82),
    lineage: lin('气象局接口', ['API数据拉取', '格式转换', '空间插值', '质量控制'], 'v1.0', '2026-05-10'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS']),
    agentBinding: ['river-crossing', 'mobility-planning'],
    scenarioTags: ['渡河保障', '机动路线规划', '态势感知'],
    audit: { auditor: '张工', auditTime: '2026-05-08', status: 'pending' },
    finetuneStatus: { used: false }
  },
  {
    id: 302,
    ...
    tags: ['水文', '流量', '淮河'],
    quality: q(90, 92, 85),
    lineage: lin('淮河水文局', ['站点数据采集', '整编', '质量控制', '空间化'], 'v1.2', '2026-03-30'),
    standardizeStatus: std(),
    tileStatus: tile(false, []),
    agentBinding: ['river-crossing', 'geo-analysis'],
    scenarioTags: ['渡河保障', '地形分析'],
    audit: { auditor: '王工', auditTime: '2026-04-22', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 303,
    ...
    resolution: '1:50000',
    coordinateSystem: 'CGCS 2000',
    bbox: [96.0, 24.0, 135.0, 53.0],
    updateTime: '2026-04-10',
    tags: ['河网', '水系', '矢量', '四大流域'],
    quality: q(93, 88, 90),
    lineage: lin('水利部', ['基础水文数据', '矢量化', '属性赋值', '拓扑检查', '质量验证'], 'v2.0', '2025-12-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['river-crossing', 'geo-analysis', 'mobility-planning'],
    scenarioTags: ['渡河保障', '地形分析', '机动路线规划'],
    audit: { auditor: '李工', auditTime: '2026-04-08', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 304,
    ...
    tags: ['湖泊', '水库', '水位', '库容'],
    quality: q(88, 92, 82),
    lineage: lin('水利遥感中心', ['卫星遥感', '水面面积反演', '水位站数据融合', '质量控制'], 'v1.1', '2026-04-20'),
    standardizeStatus: std(),
    tileStatus: tile(false, []),
    agentBinding: ['river-crossing', 'geo-analysis'],
    scenarioTags: ['渡河保障', '态势感知'],
    audit: { auditor: '张工', auditTime: '2026-05-03', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    ...
    tags: ['降雨预报', '逐时', '72h'],
    quality: q(80, 95, 75),
    lineage: lin('气象局预报系统', ['数值预报', '后处理', '空间降尺度', '格式输出'], 'v1.0', '2026-05-18'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS']),
    agentBinding: ['river-crossing', 'mobility-planning'],
    scenarioTags: ['渡河保障', '机动路线规划'],
    audit: { auditor: '王工', auditTime: '2026-05-17', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 306,
    ...
    tags: ['潮汐', '潮流', '沿海'],
    quality: q(82, 90, 78),
    lineage: lin('海洋预报台', ['潮位站数据', '潮流模型', '预报输出', '质量控制'], 'v1.0', '2026-04-15'),
    standardizeStatus: std(),
    tileStatus: tile(false, []),
    agentBinding: ['river-crossing'],
    scenarioTags: ['渡河保障'],
    audit: { auditor: '王工', auditTime: '2026-04-25', status: 'pending' },
    finetuneStatus: { used: false }
  },
  {
    id: 307,
    name: '土壤含水量遥感反演',
    ingestTime: '2026-05-02',
    timePhase: '2026Q1',
    range: '华北平原',
    type: '气象水文',
    status: 'published',
    ...
    resolution: '25m',
    coordinateSystem: 'WGS 84',
    bbox: [113.0, 34.0, 120.0, 40.0],
    updateTime: '2026-05-02',
    tags: ['土壤含水量', '微波遥感', '可通行性'],
    quality: q(85, 82, 80),
    lineage: lin('微波遥感', ['SMOS数据', '反演算法', '空间降尺度', '质量控制'], 'v1.0', '2026-03-20'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS']),
    agentBinding: ['mobility-planning', 'river-crossing'],
    scenarioTags: ['机动路线规划', '渡河保障', '地形分析'],
    audit: { auditor: '张工', auditTime: '2026-04-30', status: 'approved' },
    finetuneStatus: { used: false }
  },
  ...
  // ═══════════════ 5. 地下管网 (6 items) ═══════════════
  {
    ...
    tags: ['矢量', '管网', '地下管线'],
    quality: q(90, 85, 88),
    lineage: lin('测绘院', ['管线探测', '数据采集', '属性录入', '拓扑检查', '入库'], 'v2.1', '2025-06-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['geo-analysis'],
    scenarioTags: ['城市攻防', '态势感知'],
    audit: { auditor: '李工', auditTime: '2026-05-06', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 402,
    ...
    tags: ['供水', '管网', '阀门'],
    quality: q(92, 88, 90),
    lineage: lin('自来水公司', ['管线普查', '数据录入', '属性校验', '入库'], 'v1.5', '2025-10-10'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS']),
    agentBinding: ['geo-analysis'],
    scenarioTags: ['城市攻防'],
    audit: { auditor: '李工', auditTime: '2026-04-18', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 403,
    ...
    tags: ['燃气', '管网', '调压站'],
    quality: q(90, 85, 88),
    lineage: lin('燃气公司', ['管线探测', '数据采集', '属性录入', '入库'], 'v1.0', '2025-09-20'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS']),
    agentBinding: ['geo-analysis'],
    scenarioTags: ['城市攻防'],
  ...
  },
  {
    ...
    tags: ['电力', '管线', '电缆'],
    quality: q(88, 82, 85),
    lineage: lin('供电公司', ['管线探测', '数据采集', '属性校验', '入库'], 'v1.2', '2025-08-10'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS']),
    agentBinding: ['geo-analysis'],
    scenarioTags: ['城市攻防'],
  ...
  },
  {
    ...
    tags: ['通信', '管线', '光缆'],
    quality: q(85, 80, 82),
    lineage: lin('通信运营商', ['管线探测', '数据采集', '属性录入'], 'v1.0', '2025-07-20'),
    standardizeStatus: std(),
    tileStatus: tile(false, []),
    agentBinding: ['geo-analysis'],
    scenarioTags: ['城市攻防'],
    audit: { auditor: '李工', auditTime: '2026-04-12', status: 'pending' },
    finetuneStatus: { used: false }
  },
  {
    id: 406,
    ...
    tags: ['排水', '雨污分流', '泵站'],
    quality: q(90, 86, 88),
    lineage: lin('排水管理处', ['管线探测', '雨污分流普查', '数据录入', '质量检查', '入库'], 'v2.0', '2025-11-05'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS']),
    agentBinding: ['geo-analysis', 'river-crossing'],
    scenarioTags: ['城市攻防', '渡河保障'],
    audit: { auditor: '李工', auditTime: '2026-04-22', status: 'approved' },
    finetuneStatus: { used: false }
  },
  ...
  // ═══════════════ 6. 矢量基础地理 (8 items) ═══════════════
  {
    ...
    bbox: [117.8, 34.5, 118.3, 34.9],
    updateTime: '2026-04-15',
    tags: ['DLG', '地形图', '等高线', '1:500'],
    quality: q(95, 88, 92),
    lineage: lin('测绘院', ['外业测量', '内业编辑', '质量检查', '入库'], 'v2.0', '2025-06-10'),
    standardizeStatus: {
      coordinateTransformed: true,
      targetCRS: 'CGCS 2000',
      fieldMapped: true,
  ...
  },
  {
    ...
    finetuneStatus: {
      ...
      taskTypes: ['建筑检测'],
      sampleCount: 15000,
      annotationComplete: 60,
      modelVersion: 'BuildingSeg-v2'
    }
  },
  {
    id: 503,
    name: '城市道路路网',
    ingestTime: '2026-03-25',
    timePhase: '2025',
    range: '全国地级以上城市',
    type: '矢量基础',
    status: 'published',
    ...
    lineage: lin(
      'OSM+测绘院',
      ['OSM数据下载', '测绘数据融合', '属性补全', '拓扑检查', '质量验证'],
      'v3.0',
      '2026-01-10'
    ),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['mobility-planning', 'geo-analysis', 'planning'],
    scenarioTags: ['机动路线规划', '交通研判', '态势感知'],
    audit: { auditor: '李工', auditTime: '2026-03-22', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 504,
    ...
    bbox: [73.5, 3.8, 135.1, 53.6],
    updateTime: '2026-03-20',
    tags: ['公路', '高速公路', '国道', '通行能力'],
    quality: q(92, 88, 90),
    lineage: lin('交通运输部', ['基础数据获取', '属性更新', '拓扑检查', '入库'], 'v2.5', '2025-12-01'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['mobility-planning', 'planning'],
    scenarioTags: ['机动路线规划', '交通研判'],
    audit: { auditor: '李工', auditTime: '2026-03-18', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 505,
    name: '铁路网矢量',
    ingestTime: '2026-03-15',
    timePhase: '2025',
    range: '全国',
    type: '矢量基础',
    status: 'published',
    ...
    tags: ['铁路', '高铁', '普铁'],
    quality: q(93, 88, 90),
    lineage: lin('铁路总公司', ['基础数据获取', '属性更新', '拓扑检查'], 'v2.0', '2025-11-20'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['mobility-planning', 'geo-analysis'],
    scenarioTags: ['机动路线规划', '交通研判', '态势感知'],
    audit: { auditor: '李工', auditTime: '2026-03-12', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 506,
    name: '桥梁分布矢量',
    ingestTime: '2026-04-05',
    timePhase: '2025',
    range: '全国主要公路',
    type: '矢量基础',
    status: 'published',
    ...
    tags: ['桥梁', '承载能力', '跨径', '渡河'],
    quality: q(90, 85, 88),
    lineage: lin('交通运输部', ['桥梁普查', '数据录入', '属性校验', '空间化'], 'v1.5', '2025-10-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['river-crossing', 'mobility-planning'],
    scenarioTags: ['渡河保障', '交通研判', '机动路线规划'],
    audit: { auditor: '王工', auditTime: '2026-04-03', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 507,
    name: '行政边界（省/市/区/县）',
    ingestTime: '2026-01-15',
    timePhase: '2025',
    range: '全国',
    type: '矢量基础',
    status: 'published',
    ...
    tags: ['行政区划', '边界', '省市区县'],
    quality: q(98, 90, 95),
    lineage: lin('民政部', ['行政区划数据', '矢量化', '属性赋值', '年度更新'], 'v2025', '2025-12-31'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['geo-analysis', 'mobility-planning'],
    scenarioTags: ['态势感知', '机动路线规划'],
    audit: { auditor: '张工', auditTime: '2026-01-12', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 508,
    name: '土地利用现状',
    ingestTime: '2026-03-30',
    timePhase: '2025',
    range: '全国',
    type: '矢量基础',
    status: 'published',
    ...
    tags: ['土地利用', '分类', '耕地', '建设用地'],
    quality: q(94, 88, 92),
    lineage: lin('自然资源部', ['遥感解译', '野外验证', '矢量化', '属性赋值', '年度更新'], 'v2025', '2025-12-31'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['geo-analysis', 'mobility-planning'],
    scenarioTags: ['地形分析', '态势感知', '机动路线规划'],
    audit: { auditor: '张工', auditTime: '2026-03-28', status: 'approved' },
    finetuneStatus: { used: false }
  },
  ...
  // ═══════════════ 7. 地名地址与POI (6 items) ═══════════════
  {
    ...
    size: '120 MB',
    source: '军事测绘',
    description: '全国重点区域兵要地志数据库，含军事要地、战略要点的坐标、描述、历史战役记录等。',
    format: 'GeoJSON + 结构化文本',
    resolution: '点位级',
    coordinateSystem: 'CGCS 2000',
    bbox: [73.5, 3.8, 135.1, 53.6],
    updateTime: '2026-04-10',
    tags: ['兵要地志', '战略要点', '军事'],
    quality: q(85, 80, 82),
    lineage: lin('军事测绘', ['资料收集', '实地踏勘', '信息录入', '审核校验'], 'v1.0', '2025-09-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['geo-analysis', 'mobility-planning', 'knowledge'],
    scenarioTags: ['态势感知', '城市攻防', '地形分析'],
  ...
  },
  {
    ...
    tags: ['POI', '机场', '港口', '枢纽'],
    quality: q(90, 85, 88),
    lineage: lin('多源融合', ['公开POI', '测绘数据', '军事资料', '融合去重', '属性补全'], 'v2.0', '2026-01-20'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['geo-analysis', 'mobility-planning', 'planning'],
    scenarioTags: ['态势感知', '机动路线规划', '交通研判'],
    audit: { auditor: '张工', auditTime: '2026-04-03', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 603,
    ...
    tags: ['通信', '枢纽', '数据中心'],
    quality: q(82, 78, 80),
    lineage: lin('通信管理局', ['数据收集', '坐标赋值', '属性补全', '审核'], 'v1.0', '2025-12-10'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS']),
    agentBinding: ['geo-analysis'],
    scenarioTags: ['城市攻防', '态势感知'],
  ...
  },
  {
    ...
    tags: ['医疗', '医院', '急救'],
    quality: q(92, 88, 90),
    lineage: lin('卫健委', ['医疗机构名录', '坐标赋值', '属性补全', '年度更新'], 'v2025', '2025-12-31'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['geo-analysis', 'mobility-planning'],
    scenarioTags: ['态势感知', '城市攻防'],
    audit: { auditor: '张工', auditTime: '2026-03-12', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 605,
    ...
    tags: ['能源', '电厂', '加油站'],
    quality: q(85, 80, 82),
    lineage: lin('能源局', ['设施普查', '坐标赋值', '属性补全'], 'v1.0', '2025-11-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS']),
    agentBinding: ['geo-analysis'],
    scenarioTags: ['态势感知', '城市攻防'],
    audit: { auditor: '张工', auditTime: '2026-03-18', status: 'pending' },
    finetuneStatus: { used: false }
  },
  {
    id: 606,
    ...
    tags: ['学校', '体育场馆', '公共设施'],
    quality: q(90, 85, 88),
    lineage: lin('教育部+住建部', ['数据收集', '坐标赋值', '属性补全', '审核'], 'v2025', '2025-12-31'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['geo-analysis', 'mobility-planning'],
    scenarioTags: ['态势感知', '城市攻防'],
  ...
  // ═══════════════ 8. 战场环境专题 (6 items) ═══════════════
  {
    ...
    tags: ['气候', '温度', '湿度', '风速', '能见度'],
    quality: q(95, 88, 92),
    lineage: lin('气象局', ['站点数据收集', '质量控制', '空间插值', '气候态计算'], 'v2020', '2026-01-10'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS']),
    agentBinding: ['geo-analysis', 'river-crossing', 'mobility-planning'],
    scenarioTags: ['渡河保障', '地形分析', '态势感知'],
    audit: { auditor: '王工', auditTime: '2026-02-12', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 702,
    name: '地质与土壤类型',
    ingestTime: '2026-02-20',
    timePhase: '2025',
    range: '全国',
    type: '战场专题',
    status: 'published',
    ...
    tags: ['地质', '土壤', '岩性', '承载力'],
    quality: q(90, 85, 88),
    lineage: lin('地质调查局', ['地质调查', '采样分析', '矢量化', '属性赋值', '年度更新'], 'v2025', '2025-12-31'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['river-crossing', 'mobility-planning', 'geo-analysis'],
    scenarioTags: ['渡河保障', '机动路线规划', '地形分析'],
    audit: { auditor: '王工', auditTime: '2026-02-18', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 703,
    ...
    resolution: '100m',
    coordinateSystem: 'WGS 84',
    bbox: [110.0, 30.0, 112.0, 32.0],
    updateTime: '2026-03-10',
    tags: ['电磁', '频谱', '信号强度'],
    quality: q(78, 75, 72),
    lineage: lin('电磁频谱管理', ['频谱监测', '数据处理', '信号分析', '空间化'], 'v1.0', '2026-02-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS']),
    agentBinding: ['geo-analysis'],
    scenarioTags: ['态势感知', '城市攻防'],
    audit: { auditor: '王工', auditTime: '2026-03-08', status: 'pending' },
    finetuneStatus: { used: false }
  },
  {
    id: 704,
    name: '人口密度栅格',
    ingestTime: '2026-01-20',
    timePhase: '2025',
    range: '全国',
    type: '战场专题',
    status: 'published',
    ...
    tags: ['人口密度', 'WorldPop', '城市'],
    quality: q(88, 82, 85),
    lineage: lin('WorldPop+统计局', ['WorldPop下载', '统计局数据融合', '空间化', '质量控制'], 'v2025', '2025-12-01'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['geo-analysis', 'mobility-planning'],
    scenarioTags: ['城市攻防', '态势感知'],
    audit: { auditor: '张工', auditTime: '2026-01-18', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 705,
    name: '植被覆盖度',
    ingestTime: '2026-03-05',
    timePhase: '2025',
    range: '全国',
    type: '战场专题',
    status: 'published',
    ...
    tags: ['植被', 'FVC', '隐蔽性', '通视分析'],
    quality: q(90, 85, 88),
    lineage: lin('遥感反演', ['MODIS/Landsat数据', 'NDVI计算', 'FVC反演', '年度合成'], 'v2025', '2025-12-15'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WMS', 'WMTS']),
    agentBinding: ['geo-analysis', 'mobility-planning'],
    scenarioTags: ['地形分析', '态势感知', '机动路线规划'],
    audit: { auditor: '张工', auditTime: '2026-03-03', status: 'approved' },
    finetuneStatus: { used: false }
  },
  {
    id: 706,
    name: '地震断裂带分布',
    ingestTime: '2026-02-10',
    timePhase: '2025',
    range: '全国',
    type: '战场专题',
    status: 'published',
    ...
    tags: ['地震', '断裂带', '活动性'],
    quality: q(92, 88, 90),
    lineage: lin('地震局', ['地质调查', '历史地震整理', '矢量化', '属性赋值'], 'v2025', '2025-12-31'),
    standardizeStatus: std(),
    tileStatus: tile(true, ['WFS', 'WMS']),
    agentBinding: ['geo-analysis', 'river-crossing'],
    scenarioTags: ['地形分析', '渡河保障'],
    audit: { auditor: '王工', auditTime: '2026-02-08', status: 'approved' },
    finetuneStatus: { used: false }
  },
  ...
  // ═══════════════ 9. 障碍物与目标识别 (6 items) ═══════════════
  {
    ...
    resolution: '0.1m',
    coordinateSystem: 'N/A（图像坐标）',
    updateTime: '2026-04-20',
    tags: ['路障', '目标检测', 'COCO', '城市障碍物'],
    quality: q(90, 88, 85),
    lineage: lin('标注团队', ['图像采集', '标注', '审核', '格式转换(COCO)'], 'v2.0', '2026-03-10'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      schemaVersion: 'COCO 1.0',
      formatConverted: true,
      originalFormat: 'VOC XML'
    },
    tileStatus: tile(false, []),
    agentBinding: ['image-recognition', 'geo-analysis'],
    scenarioTags: ['目标识别', '城市攻防', '交通研判'],
    audit: { auditor: '赵工', auditTime: '2026-04-18', status: 'approved' },
    finetuneStatus: {
      used: true,
      taskTypes: ['目标检测'],
      sampleCount: 5000,
      annotationComplete: 100,
      modelVersion: 'YOLOv8-obstacle-v1'
    }
  },
  {
    id: 802,
    ...
    coordinateSystem: 'N/A（图像坐标）',
    updateTime: '2026-04-15',
    tags: ['地雷', '爆炸物', 'IED', '目标检测'],
    quality: q(88, 85, 82),
    lineage: lin('标注团队', ['图像采集', '标注', '审核', '格式转换(COCO)'], 'v1.5', '2026-02-20'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      schemaVersion: 'COCO 1.0',
    ...
    tileStatus: tile(false, []),
    agentBinding: ['image-recognition', 'mobility-planning'],
    scenarioTags: ['目标识别', '机动路线规划'],
    audit: { auditor: '赵工', auditTime: '2026-04-12', status: 'approved' },
    finetuneStatus: {
      used: true,
      taskTypes: ['目标检测'],
  ...
  },
  {
    ...
    tags: ['反坦克壕', '障碍物', '目标检测'],
    quality: q(85, 82, 80),
    lineage: lin('标注团队', ['图像采集', '标注', '审核', '格式转换(COCO)'], 'v1.0', '2026-01-15'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      schemaVersion: 'COCO 1.0',
  ...
  },
  {
    ...
    tags: ['伪装网', '隐蔽目标', '目标检测'],
    quality: q(80, 78, 75),
    lineage: lin('标注团队', ['图像采集', '标注', '审核'], 'v0.9', '2026-02-10'),
    standardizeStatus: { coordinateTransformed: false, fieldMapped: true, formatConverted: false },
    tileStatus: tile(false, []),
    agentBinding: ['image-recognition'],
    scenarioTags: ['目标识别', '态势感知'],
  ...
  },
  {
    ...
    tags: ['桥梁受损', '战损评估', '分类'],
    quality: q(88, 85, 82),
    lineage: lin('标注团队+遥感', ['遥感图像获取', '标注', '审核', '格式转换'], 'v1.0', '2026-03-15'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      schemaVersion: 'COCO 1.0',
    ...
    tileStatus: tile(false, []),
    agentBinding: ['image-recognition', 'river-crossing', 'mobility-planning'],
    scenarioTags: ['目标识别', '渡河保障', '交通研判'],
  ...
  },
  {
    ...
    tags: ['防御工事', '碉堡', '战壕', '掩体'],
    quality: q(82, 80, 78),
    lineage: lin('标注团队', ['图像采集', '标注', '审核', '格式转换'], 'v1.0', '2026-02-20'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      schemaVersion: 'COCO 1.0',
  ...
  // ═══════════════ 10. 多模态语料 (5 items) ═══════════════
  {
    ...
    updateTime: '2026-04-20',
    tags: ['情报', '报告', '文本', 'NER', '大模型微调'],
    quality: q(85, 82, 80),
    lineage: lin('整编', ['原始报告收集', '脱敏处理', '格式标准化', '分词标注'], 'v1.0', '2026-03-15'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      formatConverted: true,
      originalFormat: 'DOC/PDF'
    },
    tileStatus: tile(false, []),
    agentBinding: ['knowledge', 'geo-analysis'],
    scenarioTags: ['态势感知', '预案生成'],
    audit: { auditor: '王工', auditTime: '2026-04-18', status: 'approved' },
    finetuneStatus: {
      used: true,
      taskTypes: ['NER实体识别', '文本分类', '意图理解'],
      sampleCount: 10000,
      annotationComplete: 60,
      modelVersion: 'GeoLLM-NER-v2'
    }
  },
  {
    id: 902,
    ...
    coordinateSystem: 'N/A',
    updateTime: '2026-04-15',
    tags: ['命令', '条令', '作战指令', '大模型微调'],
    quality: q(88, 85, 82),
    lineage: lin('整编', ['条令收集', '脱敏处理', '格式标准化', '分词标注'], 'v1.0', '2026-03-10'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      formatConverted: true,
    ...
    tileStatus: tile(false, []),
    agentBinding: ['knowledge', 'geo-analysis'],
    scenarioTags: ['预案生成', '态势感知'],
    audit: { auditor: '王工', auditTime: '2026-04-12', status: 'approved' },
    finetuneStatus: {
      used: true,
      taskTypes: ['意图理解', '指令解析'],
      sampleCount: 8000,
      annotationComplete: 55,
      modelVersion: 'GeoLLM-Cmd-v1'
    }
  },
  {
    id: 903,
    ...
    size: '180 MB',
    source: '整编',
    description: '兵要地志结构化文本语料库，含地形要点、战略要地的结构化描述，适用于 RAG 检索增强生成。',
    format: 'JSONL',
    resolution: 'N/A（文本）',
    coordinateSystem: 'N/A',
    updateTime: '2026-04-10',
    tags: ['兵要地志', '结构化', '知识图谱', 'RAG'],
    quality: q(82, 80, 78),
    lineage: lin('整编', ['兵要地志资料收集', '结构化处理', '格式标准化', '质量审核'], 'v1.0', '2026-03-05'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      formatConverted: true,
    ...
    tileStatus: tile(false, []),
    agentBinding: ['knowledge', 'geo-analysis'],
    scenarioTags: ['态势感知', '地形分析', '预案生成'],
    audit: { auditor: '王工', auditTime: '2026-04-08', status: 'approved' },
    finetuneStatus: {
      used: true,
      taskTypes: ['RAG检索增强', '知识图谱'],
      sampleCount: 5000,
      annotationComplete: 45,
      modelVersion: 'GeoLLM-RAG-v1'
    }
  },
  {
    id: 904,
    ...
    format: 'MP4 + JSON标注',
    resolution: '1080p',
    coordinateSystem: 'N/A（视频）',
    updateTime: '2026-04-25',
    tags: ['无人机', '航拍', '视频', '目标跟踪'],
    quality: q(80, 78, 75),
    lineage: lin('无人机采集', ['航线规划', '视频采集', '关键帧提取', '标注'], 'v1.0', '2026-03-20'),
  ...
  },
  {
    ...
    format: 'COCO JSON + JPEG/TIFF',
    resolution: '混合（0.05-2m）',
    coordinateSystem: 'N/A（图像坐标）',
    updateTime: '2026-05-01',
    tags: ['多源', '多平台', '目标检测', '多类别'],
    quality: q(88, 85, 82),
    lineage: lin('多源融合', ['多平台影像获取', '统一标注规范', '标注', '审核', '格式统一'], 'v2.0', '2026-04-10'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      schemaVersion: 'COCO 1.0',
    ...
    finetuneStatus: {
      ...
      taskTypes: ['目标检测', '语义分割'],
      sampleCount: 20000,
      annotationComplete: 75,
      modelVersion: 'GeoDet-v3'
    }
  },
  ...
  // ═══════════════ 11. 历史方案整编 (5 items) ═══════════════
  {
    ...
    format: 'JSON + DOCX + GeoJSON',
    resolution: 'N/A（方案文档）',
    coordinateSystem: 'CGCS 2000',
    bbox: [112.0, 31.0, 113.5, 32.5],
    updateTime: '2026-03-15',
    tags: ['渡河', '保障方案', '历史', '整编'],
    quality: q(88, 82, 85),
    lineage: lin('整编', ['原始方案收集', '结构化提取', '参数标准化', '空间化', '质量审核'], 'v1.0', '2026-02-20'),
    standardizeStatus: {
      coordinateTransformed: true,
      targetCRS: 'CGCS 2000',
      fieldMapped: true,
    ...
    tileStatus: tile(false, []),
    agentBinding: ['river-crossing', 'knowledge'],
    scenarioTags: ['渡河保障', '预案生成'],
  ...
  },
  {
    ...
    resolution: 'N/A（方案文档）',
    coordinateSystem: 'CGCS 2000',
    bbox: [110.0, 28.0, 115.0, 33.0],
    updateTime: '2026-03-10',
    tags: ['机动路线', '历史方案', '整编'],
    quality: q(85, 80, 82),
    lineage: lin('整编', ['原始方案收集', '结构化提取', '路线空间化', '参数标准化', '质量审核'], 'v1.0', '2026-02-15'),
    standardizeStatus: {
      coordinateTransformed: true,
      targetCRS: 'CGCS 2000',
      fieldMapped: true,
    ...
    tileStatus: tile(false, []),
    agentBinding: ['mobility-planning', 'planning', 'knowledge'],
    scenarioTags: ['机动路线规划', '预案生成'],
    audit: { auditor: '张工', auditTime: '2026-03-08', status: 'approved' },
    finetuneStatus: {
      used: true,
      taskTypes: ['路线生成', '约束推理'],
  ...
  },
  {
    ...
    tags: ['预案', '模板', '通用', '整编'],
    quality: q(90, 85, 88),
    lineage: lin('整编', ['预案收集', '模板化处理', '结构化提取', '参数标准化', '质量审核'], 'v2.0', '2026-01-20'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      formatConverted: true,
  ...
  },
  {
    ...
    coordinateSystem: 'N/A',
    updateTime: '2026-03-20',
    tags: ['复盘', '分析报告', '经验教训', '整编'],
    quality: q(85, 80, 82),
    lineage: lin('整编', ['原始报告收集', '结构化提取', '关键信息标注', '格式标准化'], 'v1.0', '2026-02-25'),
    standardizeStatus: {
      coordinateTransformed: false,
      fieldMapped: true,
      formatConverted: true,
